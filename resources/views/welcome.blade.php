...
<head>
    ...
    <meta name="description" content="Un service qui permet de vérifier la disponibilité d'un nom de domaine.">
    <title>Avadomain - Service disponibilité nom de domaine.</title>
